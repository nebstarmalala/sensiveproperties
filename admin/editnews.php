<?php
 include('connect.php');
    ...
    if (isset($id)){
        $select_news = mysqli_query($dbconnect,"SELECT * FROM `news` WHERE `id` = '$id' ");
    ...
    if (isset($_POST['submit'])) {
      include('connect.php');
        ...
        $title =mysqli_real_escape_string ($dbconnect,$_POST['subject']);
        $description =mysqli_real_escape_string ($dbconnect,$_POST['description']);
        $created_at =date("Y-m-d H:i:s",time());

        $update=mysqli_query($dbconnect,"UPDATE `news` SET  `title`='$title',`description`='$description',`created_at`='$created_at' WHERE  `id` = '$id'");
        if($update){            
